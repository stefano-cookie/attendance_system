    ...
    return (
      <div className="min-h-screen bg-gray-900 flex justify-center items-center">
        <div className="text-center bg-gray-800 p-8 rounded-2xl shadow-xl border border-gray-700">
          ...
          <h3 className="text-xl font-semibold text-gray-300">{t('admin.classrooms.loading')}</h3>
          <p className="text-gray-400 mt-2">{t('admin.classrooms.loadingSubtext')}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-900">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">{t('admin.classrooms.title')}</h1>
                <p className="text-gray-400">{t('admin.classrooms.subtitle')}</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="flex items-center space-x-2 bg-purple-900 text-purple-300 px-4 py-2 rounded-lg hover:bg-purple-800 transition-colors"
              >
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-700 hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-400 mb-1">{t('admin.classrooms.totalClassrooms')}</p>
          ...
          <div className="bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-700 hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-400 mb-1">{t('admin.classrooms.searchResults')}</p>
                <p className="text-3xl font-bold text-white">{filteredClassrooms.length}</p>
              </div>
          ...
          <div className="bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-700 hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-400 mb-1">{t('admin.classrooms.withCamera')}</p>
                <p className="text-3xl font-bold text-white">{classroomsWithCamera}</p>
              </div>
        ...
        <div className="bg-gray-800 rounded-2xl shadow-lg border border-gray-700 mb-8">
          <div className="p-6">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-xl font-semibold text-white">{t('admin.classrooms.searchClassrooms')}</h3>
            </div>
        ...
        {error && (
          <div className="mb-6 bg-red-900/20 border-l-4 border-red-500 p-4 rounded-lg shadow">
          ...
          <div className="p-6 border-b border-gray-700">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-xl font-semibold text-white">{t('admin.classrooms.classroomList')}</h3>
              </div>
            ...
            {filteredClassrooms.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredClassrooms.map(classroom => (
                  <div
                    key={classroom.id}
                    className="bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl shadow-lg border border-gray-600 overflow-hidden hover:shadow-xl hover:scale-105 transition-all duration-300"
                  >
                    <div className="flex flex-col h-full">
                      {/* Header */}
                      <div className="p-6 bg-gradient-to-r from-gray-700 to-gray-600 border-b border-gray-600">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="flex space-x-2">
                            <button
                              ...
                              className="p-2 bg-indigo-900 text-indigo-400 rounded-lg hover:bg-indigo-800 transition-colors"
                            ...
                            {classroom.camera_ip && (
                              <button
                                ...
                                className="p-2 bg-purple-900 text-purple-400 rounded-lg hover:bg-purple-800 transition-colors disabled:opacity-50"
                            ...
                            {!classroom.camera_ip && (
                              <button
                                ...
                                className="p-2 bg-green-900 text-green-400 rounded-lg hover:bg-green-800 transition-colors"
                            ...
                            <button
                              ...
                              className="p-2 bg-red-900 text-red-400 rounded-lg hover:bg-red-800 transition-colors"
                        ...
                        <div className="space-y-3">
                          {classroom.camera_ip ? (
                            <div className="flex items-center p-3 bg-green-900/20 rounded-lg">
                              ...
                              <div>
                                <p className="text-sm font-medium text-gray-300">{t('admin.classrooms.cameraIP')}</p>
                                <p className="text-sm text-green-400 font-semibold">{classroom.camera_ip}</p>
                                {(cameraStatuses[classroom.id] || classroom.camera_status) && (
                                  <span className={`inline-block mt-1 px-2 py-1 text-xs rounded-full ${
                                    (cameraStatuses[classroom.id] || classroom.camera_status) === 'online' ? 'bg-green-900 text-green-400' :
                                    (cameraStatuses[classroom.id] || classroom.camera_status) === 'offline' ? 'bg-red-900 text-red-400' :
                                    (cameraStatuses[classroom.id] || classroom.camera_status) === 'error' ? 'bg-red-900 text-red-400' :
                            ...
                            <div className="flex items-center p-3 bg-gray-700 rounded-lg">
                              ...
                              <div>
                                <p className="text-sm font-medium text-gray-400">{t('admin.classrooms.cameraIP')}</p>
                                <p className="text-sm text-gray-500">{t('admin.classrooms.notConfigured')}</p>
                              </div>
                            </div>
                          )}
                          ...
                          <div className="flex items-center p-3 bg-purple-900/20 rounded-lg">
                            ...
                            <div>
                              <p className="text-sm font-medium text-gray-300">{t('admin.classrooms.classroomId')}</p>
                              <p className="text-sm text-purple-400 font-semibold">#{classroom.id}</p>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="text-center py-16">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">{t('admin.classrooms.noClassroomsFound')}</h3>
      ...
      {isFormOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-gray-800 rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          ...
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-gray-800 rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              <div className="bg-gray-800 px-6 pt-6 pb-4 sm:p-8 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 className="text-xl leading-6 font-bold text-white mb-2">
              ...
              <div className="bg-gray-700 px-6 py-4 sm:px-8 sm:flex sm:flex-row-reverse sm:gap-3">
                ...
                <button
                  type="button"
                  className="mt-3 w-full inline-flex justify-center rounded-lg border border-gray-600 shadow-sm px-6 py-3 bg-gray-800 text-base font-medium text-gray-300 hover:bg-gray-700 transition-colors sm:mt-0 sm:w-auto sm:text-sm"
